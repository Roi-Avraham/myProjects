...
void clientSide2(int port,string outputFile)throw (const char*){
	int serverFD = initClient(port);
	ofstream out(outputFile);
	ifstream in("/home/shira/CLionProjects/advancedPrograming/ex6/input.txt");
	string input="";
    while(input!="6"){
		readMenue(out,serverFD);
		getline(in,input);			
...
int main(){
	...
	string outputFile1="/home/shira/CLionProjects/advancedPrograming/ex6output_menu";
	string outputFile2="/home/shira/CLionProjects/advancedPrograming/ex6/output";
	int x=rand() % 1000;
	...
	size_t mistakes = check(outputFile1,"/home/shira/CLionProjects/advancedPrograming/ex6/expected_output_menu.txt");
	mistakes += check(outputFile2,"/home/shira/CLionProjects/advancedPrograming/ex6/expected_output.txt");
